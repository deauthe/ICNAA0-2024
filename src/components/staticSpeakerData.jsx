...
const keyNoteSpeakers = [
    ...
    },
    {
        ...
        image: Vetro,
        research_gate_link:
            "https://www.researchgate.net/profile/Calogero-Vetro",
    ...
    },
    {
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Vishnu-R-Vardhan",
        role: "invited speaker ",
    },
    {
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Andrey-Tetenov",
        role: "invited speaker ",
    },
    {
        name: "Dr. Kenan Tas",
    ...
    },
    {
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Anurag-Shukla-9",
        role: "invited speaker ",
    },
    {
        name: "Dr. D.R. Sahu",
    ...
    },
    {
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Qamrul-Ansari",
        role: "invited speaker ",
    },
    {
        name: "Dr. D. Bahuguna",
    ...
    },
    {
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Dhananjay-Gopal",
        role: "invited speaker ",
    },
    {
        name: "Dr. S. K. Gupta",
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Shiv-Gupta-22",
        role: "invited speaker ",
    },
    {
        name: "Dr. Pankaj Jain",
        ...
        g_scholar_link: "https://link_needed.com",
        research_gate_link:
            "https://www.researchgate.net/profile/Pankaj-Jain-6",
        role: "invited speaker ",
    },
    {
        name: "Dr. Ram Jiwari",
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Dr-Ram-Jiwari",
        role: "invited speaker ",
    },
    {
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Erdal-Karapinar",
        role: "invited speaker ",
    },
    {
...
const generalChairs = [
    ...
    },
    {
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Pawan-Sharma-43",
    },
];

const organisingSecretaries = [
    {
    ...
    },
    {
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Ganesh-Talari",
    },
];
...
const financeChairs = [
    {
        ...
        research_gate_link:
            "https://www.researchgate.net/profile/Soniya-Chaudhary",
    },
];
...
export const OrganisinSecCards = organisingSecretaries.map((item) => {
    return (
        <div key={item.name}>
            <SpeakerCard {...item} />
        </div>
...
export const HonoraryChairSpeakerCards = HonoraryChairSpeakers.map((item) => {
    return (
        <div key={item.name}>
            <SpeakerCard {...item} />
        </div>
...
export const PatronSpeakerCards = patrons.map((item) => {
    return (
        <div key={item.name}>
            <SpeakerCard {...item} />
        </div>
...
export const OrganisingChairCards = organisingChairs.map((item) => {
    return (
        <div key={item.name}>
            <SpeakerCard {...item} />
        </div>
...
export const GeneralChairCards = generalChairs.map((item) => {
    return (
        <div key={item.name}>
            <SpeakerCard {...item} />
        </div>
...
export const FinanceChairCards = financeChairs.map((item) => {
    return (
        <div key={item.name}>
            <SpeakerCard {...item} />
        </div>
