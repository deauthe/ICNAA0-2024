	...
	return (
		<div className="lg:grid grid-cols-2 gap-3">
			...
			<div className="card bg-primary text-primary-content w-full ">
				...
				<div>
					<h3 className="text-lg font-semibold my-2 ">Previous ICNAAO Events</h3>
					<ul className="grid gap-2">
						<li>
							<a className="underline" href="https://conferences.iitbhu.ac.in/ICNAAO2021/">ICNAA0-2021
							</a> at IIT BHU, Varanasi, UP, India.
						</li>
						<li>
							<a className="underline" href="https://conferences.iitbhu.ac.in/ICNAAO2022/">ICNAA0-2022</a> at IIT BHU, Varanasi, UP, India.
						</li>
						<li>
							<a  className="underline" href="https://nitdgp.ac.in/ICNAAO_2023/ap.html">ICNAAO 2023</a> at NIT Durgapur, Varanasi, UP, India.
						</li>
					</ul>
				</div>	
				</div>
